(function () {
    const themes = {
        ...
        "Forest Terminal": {
            "--semi-color-bg-0": "rgba(9, 18, 14, 1)",
            "--semi-color-bg-1": "rgba(15, 28, 21, 1)",
            "--semi-color-bg-2": "rgba(22, 38, 29, 1)",
            "--semi-color-text-0": "rgba(230, 255, 238, 0.92)",
            "--semi-color-text-1": "rgba(200, 235, 210, 0.72)",
            "--semi-color-text-2": "rgba(180, 220, 190, 0.5)",
            "--semi-color-border": "rgba(90, 180, 120, 0.16)",
            ...
            "--semi-color-primary": "rgba(70, 190, 110, 1)",
            "--semi-color-primary-hover": "rgba(95, 210, 132, 1)",
            "--semi-color-primary-active": "rgba(50, 160, 90, 1)",
            "--semi-color-primary-disabled": "rgba(70, 190, 110, 0.3)",
            "--semi-color-secondary": "rgba(140, 220, 90, 1)",
            "--semi-color-secondary-hover": "rgba(160, 235, 112, 1)",
            "--semi-color-secondary-active": "rgba(118, 190, 70, 1)",
            "--semi-color-secondary-disabled": "rgba(140, 220, 90, 0.3)",
            "--semi-color-default": "rgba(34, 52, 42, 1)",
            "--semi-color-default-hover": "rgba(45, 68, 54, 1)",
            "--semi-color-info": "rgba(80, 170, 210, 1)",
            "--semi-color-info-hover": "rgba(104, 188, 224, 1)",
            "--semi-color-info-active": "rgba(58, 145, 185, 1)",
            "--semi-color-info-disabled": "rgba(80, 170, 210, 0.3)",
            "--semi-color-success": "rgba(72, 200, 110, 1)",
            "--semi-color-success-hover": "rgba(95, 218, 132, 1)",
            "--semi-color-success-active": "rgba(52, 170, 90, 1)",
            "--semi-color-success-disabled": "rgba(72, 200, 110, 0.3)",
            "--semi-color-danger": "rgba(220, 80, 80, 1)",
            "--semi-color-danger-hover": "rgba(238, 102, 102, 1)",
            "--semi-color-danger-active": "rgba(190, 58, 58, 1)",
            "--semi-color-danger-disabled": "rgba(220, 80, 80, 0.3)",
            "--semi-color-warning": "rgba(230, 180, 50, 1)",
            "--semi-color-warning-hover": "rgba(244, 198, 76, 1)",
            "--semi-color-warning-active": "rgba(198, 150, 32, 1)",
            "--semi-color-focus-border": "rgba(70, 190, 110, 1)"
        }
    };

    const lightThemeName = "Cream Garden";
    const darkThemeName = "Forest Terminal";
